...
elem.append(`	
			...
			<a  id="playAgainstAIButton" href="/playvsai" class="bigButton greenElement">Play Chess against the AI!</a>
		
			<button  id="playAgainstPersonButton" type="submit" class="bigButton greenElement">Create a New vs Human Game</button>
